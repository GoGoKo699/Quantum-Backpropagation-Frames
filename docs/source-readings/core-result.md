...
Reading copy with mathematical rendering syntax adjusted. The source's scientific statements and wording are preserved. [Original source, plain view](../../results/PF-08/CORE_RESULT.md?plain=1).
...
\qquad
\mathrm{tr}\mathrm{Cov}_q Z\le4s.
```
